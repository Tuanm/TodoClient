...
namespace Todo.Utils {
    public class Colors {
        ...
        public static Color Red = Color.FromRgb(220, 20, 60);
        public static Color Green = Color.FromRgb(144, 238, 144);
        public static Color Yellow = Color.FromRgb(255, 250, 205);
